...
export function ComparePanel({ mentors, onRemove, onClear }: ComparePanelProps) {
    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 z-40 bg-white border-t shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)] p-4 transform transition-transform">
            <div className="container mx-auto max-w-6xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {mentors.map(mentor => (
                        <div key={mentor.id} className="border rounded-lg p-3 relative bg-gray-50 flex gap-3">
                            <button
                            ...
                            <img src={mentor.avatar} alt={mentor.name} className="h-10 w-10 rounded-full bg-gray-200" />
