...
export const MOCK_MENTORS: Mentor[] = [
    ...
    { id: '25', name: 'Sam Wilson', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Sam', headline: 'IELTS & TOEFL Prep', tags: ['IELTS', 'TOEFL', 'English'], languages: ['English'], timezone: 'UTC-5', priceStart: 28, priceEnd: 38, rating: 4.6, reviewCount: 15, responseRate: 94, credentials: [], contactInfo: { email: 's@ex.com' } },
    { id: '26', name: 'Chris Evans', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Chris', headline: 'Physics Tutor', tags: ['Physics', 'K12 Exam'], languages: ['English'], timezone: 'UTC-5', priceStart: 40, priceEnd: 50, rating: 4.8, reviewCount: 20, responseRate: 96, credentials: [], contactInfo: { email: 'c@ex.com' } },
    { id: '27', name: 'Pat Stark', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Pat', headline: 'Engineering Mentor', tags: ['Engineering', 'K12 Exam'], languages: ['English'], timezone: 'UTC-5', priceStart: 50, priceEnd: 70, rating: 4.9, reviewCount: 25, responseRate: 98, credentials: [], contactInfo: { email: 'p@ex.com' } },
    { id: '28', name: 'Morgan Lee', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Morgan', headline: 'Writing Coach', tags: ['Writing', 'IELTS', 'English'], languages: ['English'], timezone: 'UTC-5', priceStart: 45, priceEnd: 65, rating: 4.7, reviewCount: 30, responseRate: 95, credentials: [], contactInfo: { email: 'mo@ex.com' } },
